...
class LineIn2DTeaching extends MathTeaching{
    constructor(){
        ...
        this.about.push(" it passes through, or else two points.  In 2 dimensions, which is just what you have "+
        ...
        " The slope of a line is how much it goes up divided by how much it goes sideways.  This is commonly "+
        ...
        "If you know two points in a line, you can use them to get the slope by subtracting the y from one from the "+
        "other to get the change in y, subtracting the x from the one from the other to get the change in x, and "+
        "then dividing change in y by change in x.  Negative signs do matter.  You also need to have at least one "+
        "point the line goes through.  This lets you know where the line passes through.  Because lines's slopes "+
        "do not change, they are perfectly straight.  Because nothing stops them from continuing, they go on forever.");
    }
}
