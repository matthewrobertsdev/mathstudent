...
class LineIn2DTeaching extends MathTeaching{
    constructor(){
        ...
        "If you know two points in a line, you can use them to get the slope.  Subtract the y from one point from from the "+
        ...
        "Because lines's slopes do not change, they are perfectly straight.  Because nothing stops them from continuing, they "+
        "go on forever.");
    }
}
