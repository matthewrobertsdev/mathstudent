...
*/
/*
export const setFound = () => { return {type: 'SET_FOUND'} };
...
export const updateKeyAndValue = (key, value) => {
	return (dispatch) => {
...
export const setDisplayTeaching = (boolean) => { return (dispatch) => { return dispatch(_setDisplayTeaching(boolean)); }; }

export const updateDisplayKeyboard = (isDisplayed) => { return (dispatch) => { return dispatch(_updateDisplayKeyboard(isDisplayed)); }; }
...
export const setParamaterLabels = (labelArray) => { return (dispatch) => { return dispatch(_setParamaterLabels(labelArray)); }; }

const _updateSimplestForm = (simplestForm) => ({ type: 'UPDATE_SIMPLEST_FORM', simplestForm });

export const updateActiveMethod = (activeMethod) => { return (dispatch) => { return dispatch(_updateActiveMethod(activeMethod)); }; }
