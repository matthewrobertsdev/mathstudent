...
class FractionTeaching extends MathTeaching{
	constructor(){
		...
		const ADD=['Add a Fraction', addHeading, 'addAFraction', 'numerator', 'integer', 'denominator', 'integer'];
		...
		const SUBTRACT=['Subtract a Fraction', subtractHeading, 'subtractAFraction', 'numerator', 'integer', 'denominator', 'integer'];
		...
		const MULTIPLY=['Multiply by a Fraction', multiplyHeading, 'multiplyByAFraction', 'numerator', 'integer', 'denominator', 'integer'];
		...
		const DIVIDE=['Divide By a Fraction', dvideHeading, 'divideByAFraction', 'numerator', 'integer', 'denominator', 'integer'];
