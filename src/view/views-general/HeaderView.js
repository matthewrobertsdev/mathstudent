...
class UnconnectHeaderView extends React.Component{
      ...
      createNavBar() { var headerView=[];
        ...
        if (this.props.URLpathname!=='/version')headerView.push(this.createVersionPageLink());
      ...
      createVersionPageLink(){ return (<NavLink className='NavLink float-left' to='/version' key={4}>Version</NavLink>); }
      goBack(){
